        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActice = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    LastActive = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserConversation", x => new { x.ConversationsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_AppUserConversation_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserConversation_UsersId",
